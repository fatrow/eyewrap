...
Code is completely macroexpanded and all exception is catched by eyewrap.
...
All exception is catched by cap fortunately or unfortunately.
...
*(ppp :c)*     : clear cache.
*(ppp :pp)*    : print internal data structure.
